<template>
  ...
  <header @load="on_data_load()" class="header">
      ...
      <nav class="nav">
        ...
        <div class="nav-right">
            ...
            <svg class="nav-on" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <g id="SVGRepo_iconCarrier">
                <g id="Menu / Hamburger_LG">
                  <path id="Vector" d="M3 17H21M3 12H21M3 7H21" stroke="#ffffff" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round"></path>
                </g>
              </g>
            </svg>
            <svg class="nav-off" viewBox="-65 -65 512 512" version="1.1" xml:space="preserve"
                ...
                <g id="_x37_12-_close__x2C__cross__x2C__cancel__x2C_">
                  <g>
                    <line style="
                      ...
                      " x1="350.21" x2="26.739" y1="26.814" y2="350.139"></line>
                    <line style="
                        fill: none;
                        stroke: #fff;
                        stroke-width: 13.4167;
                        ...
                        stroke-linejoin: round;
                        stroke-miterlimit: 2.6131;
                      " x1="350.21" x2="26.739" y1="350.139" y2="26.814"></line>
                  </g>
                </g>
                <g id="Layer_1"></g>
              </g>
          ...
          <ul class="nav-list">
            ...
            <li><router-link @click="toggleMenu" to="/about" class="nav-link">Каталог</router-link></li>
            ...
            <li><router-link @click="toggleMenu" to="/company" class="nav-link">Контакты</router-link></li>
            <li><router-link @click="toggleMenu" to="/order-call" class="nav-link order-call">Заказать звонок</router-link></li>
            <li><input type="search" name="search button" id="search"></li>
            <li>
